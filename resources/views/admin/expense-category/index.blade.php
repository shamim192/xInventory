        ...
        <div class="card">
            <div class="card-header">
                <div class="d-lg-flex justify-content-between align-items-center">
                    ...
                    <div class="d-lg-flex">
                        <form method="GET" action="{{ route('expense-category.index') }}"
                            ...
                            <div class="form-group mb-0">
                                ...
                                <a class="btn btn-outline-secondary btn-flat" href="{{ route('expense-category.index') }}"><i
                                        class="fa fa-times"></i></a>
                             
                                    <a class="btn btn-secondary btn-flat" href="{{ route('expense-category.create') . qString() }}"><i
                                    ...
                                    <td>
                                        <x-sp-components::action-group>                                            
                                                <a class="dropdown-item"
                                                    href="{{ route('expense-category.show', $val->id) . qString() }}"><i
                                                        class="fa fa-eye"></i> Show</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('expense-category.edit', $val->id) . qString() }}"><i
                                                        class="fa fa-pencil"></i> Edit</a>                                                       
                                                <a class="dropdown-item"
                                                    onclick="deleted('{{ route('expense-category.destroy', $val->id) . qString() }}')"><i
