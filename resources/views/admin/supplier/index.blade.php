                    ...
                    <div class="d-lg-flex">
                        <form method="GET" action="{{ route('supplier.index') }}"
                            ...
                            <div class="form-group mb-0">
                                ...
                                <a class="btn btn-outline-secondary btn-flat" href="{{ route('supplier.index') }}"><i
                                        class="fa fa-times"></i></a>
                             
                                    <a class="btn btn-secondary btn-flat" href="{{ route('supplier.create') . qString() }}"><i
                                    ...
                                    <td>
                                        <x-sp-components::action-group>                                            
                                                <a class="dropdown-item"
                                                    href="{{ route('supplier.show', $val->id) . qString() }}"><i
                                                        class="fa fa-eye"></i> Show</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('supplier.edit', $val->id) . qString() }}"><i
                                                        class="fa fa-pencil"></i> Edit</a>                                                       
                                                <a class="dropdown-item"
                                                    onclick="deleted('{{ route('supplier.destroy', $val->id) . qString() }}')"><i
