                    ...
                    <div class="d-lg-flex">
                        <form method="GET" action="{{ route('expense.index') }}"
                            ...
                            <div class="form-group mb-0">
                                ...
                                <a class="btn btn-outline-secondary btn-flat" href="{{ route('expense.index') }}"><i
                                        class="fa fa-times"></i></a>
                                <a class="btn btn-secondary btn-flat"
                                    href="{{ route('expense.create') . qString() }}"><i class="fa fa-plus"></i>
                                    Add</a>
                            </div>
                        </form>
                    </div>
                                    ...
                                    <td>
                                        <x-sp-components::action-group>
                                            <a class="dropdown-item"
                                                href="{{ route('expense.show', $val->id) . qString() }}"><i
                                                    class="fa fa-eye"></i> Show</a>
                                            <a class="dropdown-item"
                                                href="{{ route('expense.edit', $val->id) . qString() }}"><i
                                                    class="fa fa-pencil"></i> Edit</a>
                                            <a class="dropdown-item"
                                                onclick="deleted('{{ route('expense.destroy', $val->id) . qString() }}')"><i
