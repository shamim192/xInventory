        ...
        <div class="card">
            <div class="card-header">
                <div class="d-lg-flex justify-content-between align-items-center">
                    <h4 class="m-0">Fund Transfers</h4>
                    <div class="d-lg-flex">
                        <form method="GET" action="{{ route('fund-transfer.index') }}"
                            ...
                            <div class="form-group mb-0">
                                ...
                                <a class="btn btn-outline-secondary btn-flat" href="{{ route('fund-transfer.index') }}"><i
                                        class="fa fa-times"></i></a>
                                    <a class="btn btn-secondary btn-flat"
                                        href="{{ route('fund-transfer.create') . qString() }}"><i class="fa fa-plus"></i>
                                        Add</a>
                            </div>
                        </form>
                    </div>
                    ...
                    <table class="table table-bordered table-hover myTable">
                        ...
                        <tbody>
                            @foreach ($records as $val)
                                <tr>
                                    <td>{{ optional($val->fromBank)->name }}</td>
                                    <td>{{ optional($val->toBank)->name }}</td>
                                    ...
                                    <td>
                                        <x-sp-components::action-group>
                                                <a class="dropdown-item"
                                                    href="{{ route('fund-transfer.show', $val->id) . qString() }}"><i
                                                        class="fa fa-eye"></i> Show</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('fund-transfer.edit', $val->id) . qString() }}"><i
                                                        class="fa fa-pencil"></i> Edit</a>
                                                <a class="dropdown-item"
                                                    onclick="deleted('{{ route('fund-transfer.destroy', $val->id) . qString() }}')"><i
