                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="{{ route('customer-payments.index') . qString() }}">
                            <i class="fas fa-list" aria-hidden="true"></i> Customer Payment List
                        </a>
                    </li>

                    @can('add customer_payment')
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('customer-payments.create') . qString() }}">
                                <i class="fas fa-plus" aria-hidden="true"></i> Add Customer Payment
                            </a>
                        </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark active" href="javascript:void(0);">
                            <i class="fas fa-eye" aria-hidden="true"></i> Customer Payment Details
                        </a>
                    </li>
                </ul>
            </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th style="text-align: right;">{{ $data->transactions->sum('amount') }}</th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
