                    ...
                    <div class="d-lg-flex">
                        <form method="GET" action="{{ route('companies.index') }}"
                            ...
                            <div class="form-group mb-0">
                                ...
                                <a class="btn btn-outline-secondary btn-flat" href="{{ route('companies.index') }}"><i
                                        class="fa fa-times"></i></a>
                             
                                    <a class="btn btn-secondary btn-flat" href="{{ route('companies.create') . qString() }}"><i
                                    ...
                                    <td>
                                        <x-sp-components::action-group>                                            
                                                <a class="dropdown-item"
                                                    href="{{ route('companies.show', $val->id) . qString() }}"><i
                                                        class="fa fa-eye"></i> Show</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('companies.edit', $val->id) . qString() }}"><i
                                                        class="fa fa-pencil"></i> Edit</a> 
                                                <a class="dropdown-item"
                                                    onclick="deleted('{{ route('companies.destroy', $val->id) . qString() }}')"><i
