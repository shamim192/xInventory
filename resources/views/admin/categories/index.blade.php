...
@section('title_prepend', 'Category')
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-lg-flex justify-content-between align-items-center">
                    ...
                    <div class="d-lg-flex">
                        <form method="GET" action="{{ route('categories.index') }}" class="d-lg-flex justify-content-end">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <a class="btn btn-outline-secondary btn-flat" href="{{ route('categories.index') }}"><i
                                        class="fa fa-times"></i></a>

                                <a class="btn btn-secondary btn-flat" href="{{ route('categories.create') . qString() }}"><i
                                    ...
                                    <td>
                                        <x-sp-components::action-group>
                                            <a class="dropdown-item"
                                                href="{{ route('categories.show', $val->id) . qString() }}"><i
                                                    class="fa fa-eye"></i> Show</a>
                                            <a class="dropdown-item"
                                                href="{{ route('categories.edit', $val->id) . qString() }}"><i
                                                    class="fa fa-pencil"></i> Edit</a>
                                            <a class="dropdown-item"
                                                onclick="deleted('{{ route('categories.destroy', $val->id) . qString() }}')"><i
